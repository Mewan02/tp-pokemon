...
/**
 * This class represents the server application, which is a Pokémon Bank. It is
 * a shared account: everyone's Pokémons are stored together.
 *
 * @author strift
 *
 */
public class PokemonBank {
     ...
     * Constructor
     *
     * @param port	the port on which the server should listen IT's false not
     * param
    ...
    public PokemonBank() throws IOException, ClassNotFoundException {
        ...
        ServerSocket = new ServerSocket(SERVER_PORT, 1, InetAddress.getLocalHost());//new ServerSocket(numer_port,nbr_max,adresse_locale);
            ...
            switch (request) {
                case LIST:
                    ...
                    if (this.pokemons.size() == 0) {
                         ...
                         */
                        oos.writeObject("0 pokemon in database.");
                        oos.flush();
                        ...
                        for (int i = 0; i < pokemons.size(); i++) {
                            strb.append(pokemons.get(i));
                            strb.append("\n");
                        }
                        oos.writeObject(strb);
                        oos.flush();
                ...
                case STORE:
                     ...
                     */
                    oos.writeObject("Pokemon is safe.");
                    oos.flush();
                    break;
                ...
                case CLOSE:
                     ...
                     */
                    oos.writeObject("Tzke care trainer !!!");
